...
export const SHOPIFY_STOREFRONT_TOKEN = "e73d1dd798b7661cd82b6425d7b19d25";
...
export const SHOPIFY_LOGIN_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/account/login`;
