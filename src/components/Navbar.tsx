            ...
            <PopoverContent className="w-60 p-3 bg-card border border-border shadow-lg" align="end">
              ...
              <div className="space-y-2">
                <a
                  ...
                  className="flex items-center justify-center gap-2.5 rounded-lg px-4 py-2.5 text-sm font-semibold text-white bg-[#5A31F4] hover:bg-[#4b28d4] transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2.5 rounded-lg px-4 py-2.5 text-sm font-semibold text-[#1f1f1f] bg-white border border-[#dadce0] hover:bg-[#f8f9fa] transition-colors"
                >
                ...
                <a
                  href={`https://${SHOPIFY_STORE_DOMAIN}/account/register`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2.5 rounded-lg px-4 py-2.5 text-sm font-semibold text-primary-foreground bg-primary hover:bg-primary/90 transition-colors"
                >
