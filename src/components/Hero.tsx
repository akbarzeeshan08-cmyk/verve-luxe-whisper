      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-12">
        <div className="max-w-xl">
          ...
          >
            ...
            <a
              href="#story"
              className="inline-block border border-cream/40 text-cream font-sans text-sm tracking-widest uppercase px-8 py-4 hover:bg-cream/10 transition-colors duration-300"
            >
              Our Story
            </a>
          </div>
